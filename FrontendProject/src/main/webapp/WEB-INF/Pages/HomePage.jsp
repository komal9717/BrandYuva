...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <img src="${images}/img5.jpg" alt="Image 5" style="height:600px;width:1200px">
    </div>
    
    <div class="item">
      <img src="${images}/img6.jpg" alt="Image 6" style="height:600px;width:1200px">
    </div>
...
<div class="jumbotron">
    <h1>Brand Yuva</h1> 
    <p>We are Brand Yuva. We respect your privacy and
     private life, and sometimes we need your personal 
     data. In this privacy policy, we explain which data
      we use and how we save, protect and process this 
   		data. This privacy policy applies to our website 
   		omybag.nl  and the services that we offer 
   		(the "Services"). We comply with the General Data 
   		Protection Regulation (the "GDPR") and, when implemented, 
   		with the relevant provisions under Dutch law. We will refer
   		 to both the GDPR and the Dutch implementation of it as the 
